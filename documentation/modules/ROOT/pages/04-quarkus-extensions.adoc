...
[source,bash,subs="+macros,+attributes"]
----
mvn  quarkus:add-extension -Dextension="{quarkus-rest-client-ext-name}"
----
...
[source,bash,subs="+macros,+attributes"]
----
mvn  quarkus:add-extension -Dextension="{quarkus-fault-tolerance-ext-name}"
----
...
[source,bash,subs="+macros,+attributes"]
----
mvn  quarkus:add-extension -Dextension="{quarkus-health-ext-name}"
----
...
[source,bash,subs="+macros,+attributes"]
----
mvn  quarkus:add-extension -Dextension="{quarkus-jwt-ext-name}"
----
